...
func GetServersHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.GetServersReq
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := servers.NewGetServersLogic(r.Context(), svcCtx)
		resp, err := l.GetServers(&req)
		if err != nil {
